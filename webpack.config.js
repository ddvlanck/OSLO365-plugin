...
module.exports = async (env, options) => {
  ...
  const config = {
    ...
    entry: {
      ...
      search: "./src/taskpane/search/search.ts",
      documentCheck: "./src/taskpane/auto-check/documentCheck.ts",
      dictionary: "./src/taskpane/dictionary/dictionary.ts",
      settings: "./src/taskpane/help-settings/settings.ts"
    },
    resolve: {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        template: "./src/taskpane/search/search.html",
        chunks: ["polyfill", "search"]
      }),

      new HtmlWebpackPlugin({
        filename: "documentCheck.html",
        template: "./src/taskpane/auto-check/documentCheck.html",
        chunks: ["polyfill", "documentCheck"]
      }),

      new HtmlWebpackPlugin({
        filename: "dictionary.html",
        template: "./src/taskpane/dictionary/dictionary.html",
        chunks: ["polyfill", "dictionary"]
      }),

      new HtmlWebpackPlugin({
        filename: "settings.html",
        template: "./src/taskpane/help-settings/settings.html",
        chunks: ["polyfill", "settings"]
      }),

      new HtmlWebpackPlugin({
        filename: "functions.html",
        template: "./src/taskpane/functions/functions.html"
      }),

      new HtmlWebpackPlugin({
        filename: "help.html",
        template: "./src/taskpane/help-settings/help.html",
        chunks: ["polyfill"]
      }),
